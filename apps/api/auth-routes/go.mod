module github.com/lee5i3/tcg-api/apps/api/auth-routes
...
require (
	...
	github.com/lee5i3/tcg-api/libs/user-accounts v0.0.0
)
...
replace (
	...
	github.com/lee5i3/tcg-api/libs/user-accounts => ../../../libs/user-accounts
)
